      ...
      schemas: {
        ...
        Audit: {
          ...
          properties: {
            ...
            phase: { type: 'string', enum: ['cadrage', 'prerequis', 'revue_documentaire', 'realisation', 'termine'], example: 'realisation' },
        ...
        Evaluation: {
          ...
          properties: {
            ...
            niveau_maturite: { type: 'integer', minimum: -2, maximum: 5, nullable: true, example: 3, description: '-2 = N/A Annex A ISO, -1 = domaine non applicable DNSSI, null = non évalué, 0-5 = niveau maturité CMM' },
            conformite: { type: 'string', enum: ['non_conforme', 'partiel', 'conforme', 'nc_mineure', 'nc_majeure', 'na'], example: 'partiel' },
            commentaire: { type: 'string', nullable: true, example: 'Politique en cours de rédaction' },
            recommandation: { type: 'string', nullable: true, example: 'Formaliser la politique de contrôle des accès' },
            preuve: { type: 'string', nullable: true, example: 'Référence DOC-123' },
            note: { type: 'string', nullable: true, example: 'Constaté lors de l\'entretien du 10/06' },
          },
        },
          ...
          properties: {
            evaluations: {
              ...
              items: {
                ...
                properties: {
                  mesure_id: { type: 'integer', example: 42 },
                  niveau_maturite: { type: 'integer', minimum: -2, maximum: 5, nullable: true, example: 3, description: '-2 = N/A Annex A, -1 = N/A DNSSI, null = non évalué, 0-5 = niveau CMM' },
                  commentaire: { type: 'string', example: 'Politique en cours' },
                  recommandation: { type: 'string', example: 'Formaliser la politique' },
                  preuve: { type: 'string', example: 'DOC-123' },
                  note: { type: 'string', example: 'Note brute de l\'auditeur' },
                },
              },
            },
          },
        ...
        Document: {
          ...
          properties: {
            id: { type: 'integer', example: 1 },
            audit_id: { type: 'integer', example: 3 },
            nom_original: { type: 'string', example: 'politique_securite.pdf' },
            nom_fichier: { type: 'string', example: '1715000000000-abc123.pdf' },
            type_mime: { type: 'string', example: 'application/pdf' },
            taille: { type: 'integer', example: 204800, description: 'Taille en octets' },
            uploaded_by: { type: 'integer', example: 2 },
            is_correction: { type: 'boolean', example: false, description: 'true si le document est une correction d\'un refus' },
            statut: { type: 'string', enum: ['en_attente', 'valide', 'refuse'], example: 'en_attente' },
            constat: { type: 'string', nullable: true, example: 'Document illisible, veuillez renvoyer.' },
