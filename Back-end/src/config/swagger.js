      ...
      schemas: {
        ...
        Evaluation: {
          ...
          properties: {
            ...
            niveau_maturite: { type: 'integer', minimum: -1, maximum: 5, nullable: true, example: 3, description: '-1 = domaine non applicable, null = non évalué, 0-5 = niveau maturité CMM' },
          ...
          properties: {
            evaluations: {
              ...
              items: {
                ...
                properties: {
                  mesure_id: { type: 'integer', example: 42 },
                  niveau_maturite: { type: 'integer', minimum: -1, maximum: 5, nullable: true, example: 3, description: '-1 = domaine non applicable, null = non évalué, 0-5 = niveau CMM' },
