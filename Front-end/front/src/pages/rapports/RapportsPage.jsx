                                            ...
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                {canArchive && (
                                                    <button
                                                        ...
                                                        className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-xl bg-white border border-gray-200 text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                                    >
                                                        ...
                                                        {isArchivingRapport ? 'Archivage…' : 'Archiver rapport'}
                                                    </button>
                                                )}
                                            </div>
                                        </td>
