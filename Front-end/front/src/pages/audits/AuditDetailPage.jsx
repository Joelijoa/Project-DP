                ...
                <div className="grid grid-cols-4 gap-3">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4">
                        <div className="flex items-start justify-between mb-4">
                            <p className="text-xs font-medium text-gray-400">Mesures évaluées</p>
                    ...
                    {(() => {
                        ...
                        return (
                            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4">
                                <div className="flex items-start justify-between mb-4">
                                    <p className="text-xs font-medium text-gray-400">Taux de conformité</p>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4">
                        <div className="flex items-start justify-between mb-4">
                            <p className="text-xs font-medium text-gray-400">Non-conformités</p>
                            <div className="p-1.5 rounded-lg bg-gray-50 text-gray-400">
                                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        ...
                        <p className="text-3xl font-bold text-gray-900 tracking-tight">{totalNC}</p>
                    </div>

                    {/* Plans d'actions */}
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4">
                        <div className="flex items-start justify-between mb-4">
                            <p className="text-xs font-medium text-gray-400">Plans d'actions</p>
                            <div className="p-1.5 rounded-lg bg-gray-50 text-gray-400">
                                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        ...
                        <p className="text-3xl font-bold text-gray-900 tracking-tight">{planActions.length}</p>
                    </div>
                </div>
            )}
