                                ...
                                {auto ? (
                                    ...
                                    <div className="flex items-center gap-2 w-48">
                                        <input
                                            ...
                                            readOnly={readOnly}
                                            placeholder="—"
                                            className={`w-full text-sm border border-gray-200 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 text-right ${readOnly ? 'bg-white text-gray-700 cursor-not-allowed' : ''}`}
                                            style={{ color: '#111827', '--tw-ring-color': 'var(--brand-red)' }}
                                        />
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 w-48">
                                <input
                                    ...
                                    readOnly={readOnly}
                                    placeholder="—"
                                    className="w-full text-sm border border-gray-200 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 text-right read-only:bg-white read-only:text-gray-700 read-only:cursor-not-allowed"
                                    style={{ color: '#111827', '--tw-ring-color': 'var(--brand-red)' }}
                                />
